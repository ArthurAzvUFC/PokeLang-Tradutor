# -*- coding: utf-8 -*-
import sys          # Para ler argumentos do terminal (sys.argv)
import os           # Para verificar e deletar arquivos (os.path, os.remove)
import subprocess   # Para rodar o comando final no terminal
import pokelang     # Importa seu motor de tradução
...
def main():
    ...
    # Chama a função converter_arquivo que está no pokelang.py
